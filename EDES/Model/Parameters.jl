...
function Parameters(
    ...
    k3 = 6.07e-3,  # k3 rate constant for suppresstion of hepatic glucose release by change of plasma glucose
    k4 = 2.35e-4,  # k4 rate constant for suppression of hepatic glucose release by delayed (remote) insulin
    ...
    k9 = 3.83e-2,  # k9 rate constant for outflow of insulin from plasma to interstitial space
