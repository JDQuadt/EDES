...
function Parameters(
    ...
    k7 = 1.15,     # k7 rate constant for integral of glucose on insulin production (beta cell function)
    k8 = 7.27,   #5  # k8 rate constant for the simulation of insulin production by the rate of change in plasma glucose concentration (beta cell function)
