...
function Parameters(
    ...
    k7 =  0.5,#1.15,     # k7 rate constant for integral of glucose on insulin production (beta cell function) [1/min]
    ...
    sigma = 1.8,#1.4,   # sigma shape factor (appearance of meal)
