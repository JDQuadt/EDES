...
function Parameters(
    ...
    k7 =  0.2,#1.15,     # k7 rate constant for integral of glucose on insulin production (beta cell function) [1/min]
    ...
    k9 = 2e-2,# 3.83e-2,  # k9 rate constant for outflow of insulin from plasma to interstitial space [1/min]
    k10 = 1.5,#2.84e-1, # k10 rate constant for degredation of insulin in remote compartment [1/min]
